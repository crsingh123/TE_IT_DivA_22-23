    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="ToysProduct.php"</script>';
            }else{
...
<div class="header">
        <div class="container2">
                ...
                <div class="logo">
                    ...
                    <nav>
                        <ul id="MenuItems">
                            ...
                            <li><a href="chocolateproduct.php">Products</a></li>
            ...
            <div class="row" style="margin-left:20px;padding-left:50px">
                <div class="col-2">
                    <h1>End of tensions, start of creation</h1>
                    <p></p>
     ...
     <h2 style="color:black; font-size:28px; background-color:#ffb6c1;">TOYS</h2><br><br>
    <div class="container" style="width: 70%">

        <?php
            $query = "SELECT * FROM product_toy ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="ToysProduct.php?action=add&id=<?php echo $row["id"]; ?>">
