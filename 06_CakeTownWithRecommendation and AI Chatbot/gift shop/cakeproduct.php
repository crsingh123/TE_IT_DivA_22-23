    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="cakeproduct.php"</script>';
            }else{
...
<div class="header">
        <div class="container2">
            ...
            <div class="row" style="margin-left:20px;padding-left:50px">
                <div class="col-2">
                    <h1>A cake that indulges you</h1>
                    <p></p>
     ...
     <h2 style="color:black; font-size:28px; background-color:#ffb6c1;">Cake</h2><br><br>
    <div class="container" style="width: 70%">

        <?php
            $query = "SELECT * FROM product_cake ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="cakeproduct.php?action=add&id=<?php echo $row["id"]; ?>">
