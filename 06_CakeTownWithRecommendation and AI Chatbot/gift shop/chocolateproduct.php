    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="chocolateproduct.php"</script>';
            }else{
...
<head>
    ...
    <title>Products-Chocolate</title>
...
<div class="header">
        <div class="container2">
                ...
                <div class="logo">
                    ...
                    <nav>
                        ...
                        <li><a href="indexnwer.php">Home</a></li>
                            <li><a href="cakeproduct.php">Products</a></li>
            ...
            <div class="row" style="margin-left:20px;padding-left:50px">
                ...
                <div class="col-2">
                    <img src="chocolatebg.jpg" style="padding-right:20px; height: 500px;"> 
                </div>
     ...
     <h2 style="color:black; font-size:28px; background-color:#ffb6c1;">Chocolate</h2><br><br>
    <div class="container" style="width: 70%">

        <?php
            $query = "SELECT * FROM product_chocolate ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="chocolateproduct.php?action=add&id=<?php echo $row["id"]; ?>">
