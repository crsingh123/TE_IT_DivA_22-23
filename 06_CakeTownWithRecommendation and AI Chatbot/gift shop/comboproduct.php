    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="comboproduct.php"</script>';
            }else{
...
<div class="header">
        <div class="container2">
                ...
                <div class="logo">
                    ...
                    <nav>
                        ...
                        <li><a href="indexnwer.php">Home</a></li>
                            <li><a href="mugproduct.php">Products</a></li>
            ...
            <div class="row" style="margin-left:20px;padding-left:50px">
                <div class="col-2">
                    <h1>Best gifts put together</h1>
                    <p></p>
                    <a href="" class="btn1">Explore Now &#8594;</a>
                </div>
                <div class="col-2">
                    <img src="toysheader.jpg"> 
                </div>
     ...
     <h2 style="color:black; font-size:28px; background-color:#ffb6c1;">COMBO</h2><br><br>
    <div class="container" style="width: 70%">

        <?php
            $query = "SELECT * FROM product_combo ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="comboproduct.php?action=add&id=<?php echo $row["id"]; ?>">
            ...
            <div class="row">
                <div class="footer-col-1" style="margin-left:30px;padding:50px">
                    ...
                    <div class="app-logo">
                        ...
                        <a href="https://www.apple.com/store"><img src="app-store.png" style="padding-left:10px; width:40px;"></a>
