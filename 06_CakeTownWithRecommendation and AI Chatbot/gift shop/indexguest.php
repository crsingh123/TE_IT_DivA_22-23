...
<body>
    <div class="header">
        <div class="container">
            <div class="navbar">
                <div class="logo">
                    <img src="giftbg.png" width="155px" height="50px">
                    </div>
                    <nav>
                        <ul id="MenuItems">
                            <li><a href="indexguest.php">Home</a></li>
                            <li><a href="productsguest.php">Products</a></li>
                            <li><a href="reglogin.php">Contact</a></li>
...
<div class="offer">
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
                <p>Exclusively Avaliable at Cake Town GiftMania</p>
                ...
                <a href="" class="btn1">Experience Now &#8594</a>
            </div>
        </div>
    </div>
</div>
...
<div class="offer1">
    <div class="small-container">
        <div class="row">
            <div class="col-10">
                <img src="cfbg1.jpeg" class="offer-img2">
            </div>
            <div class="col-10">
