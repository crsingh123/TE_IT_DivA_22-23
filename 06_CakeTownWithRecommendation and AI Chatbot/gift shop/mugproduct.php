    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="mugproduct.php"</script>';
            }else{
...
<div class="header">
        <div class="container2">
            ...
            <div class="row" style="margin-left:20px;padding-left:50px">
                <div class="col-2">
                    <h1>The mug with which you start your day</h1>
                    <p></p>
                    <a href="" class="btn1">Explore Now &#8594;</a>
                </div>
                <div class="col-2">
                    <img src="personalmugs.jpg" style="padding-right:20px;"> 
                </div>
     ...
     <h2 style="color:black; font-size:28px; background-color:#ffb6c1;">MUGS</h2><br><br>
    <div class="container" style="width: 70%">

        <?php
            $query = "SELECT * FROM product_mug ORDER BY id ASC ";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="mugproduct.php?action=add&id=<?php echo $row["id"]; ?>">
